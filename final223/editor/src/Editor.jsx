...
export default function Editor({requiredMentions}) {
...
//   console.log("Required Mentions:", requiredMentions);
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="mt-6">
        <h4 className="text-lg font-semibold mb-2">Delta:</h4>
        <pre
          ref={deltaRef}
          className="bg-black-100 text-pink-800 p-4 rounded-lg text-sm max-h-[200px] overflow-auto font-mono border"
        />
        <button
          className="mt-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md shadow-sm transition-colors duration-200"
          onClick={() => {
            console.log(doc.getDelta());
        ...
        <button
        className="ms-3 mt-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md shadow-sm transition-colors duration-200"
        onClick={() => {
          mentions.current = false;
          console.log("Set mention false");
        }}
        >Set mention false</button>
      </div>
    </div>
  );
}
